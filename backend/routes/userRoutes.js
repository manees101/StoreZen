...
import { getUser, updateUser, updateUserPasssword,deleteAddress,updateAddress, getAllUsers, deleteUser,getUserInfo, updateAvatar, forgotPassword, verifyForgotOTP, resetPassword } from "../controllers/userController.js"
...
userRouter.route("/all").get(isAdmin)
