...
import { getAllProductsShop } from "../../../store/actions/product";
...
const ProductDetails = ({ data }) => {
  ...
  const handleMessageSubmit = async () => {
    if (isAuthenticated) {
      ...
      await axios
        .post(`${server}/conversation/createNewConversation`, {
          groupTitle,
          userId,
          sellerId,
        })
          ...
          <div className="w-full py-5">
            <div className="block w-full md:flex">
              ...
              <div className="w-full md:w-[50%] pt-5">
                ...
                <p>{data.description.length >300 ?  `${data.description.slice(0,300)}...`:data.description}</p>
