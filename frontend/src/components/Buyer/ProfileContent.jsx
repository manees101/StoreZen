...
import { getAllOrdersOfUser } from "../../store/actions/order";
        ...
        <>
          ...
          <div className="w-full px-5">
            <form onSubmit={handleSubmit} aria-required={true}>
              ...
              <input
                className={`w-[250px] h-[40px] bg-secondary text-center text-white rounded-[3px] mt-8 cursor-pointer`}
                required
                value="Update"
                type="submit"
              />
              ...
              <form aria-required onSubmit={handleSubmit} className="w-full">
                <div className="w-full block p-4">
                  ...
                  <div className=" w-full pb-2">
                    <input
                      type="submit"
                      className={`${styles.input} mt-5 cursor-pointer border-[2px] border-secondary`}
                      required
                      readOnly
                    />
                  </div>
